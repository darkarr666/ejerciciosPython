...
if menores: #si la lista menores no está vacía
    ...
    print("No se ingresó ninguna edad de menores :) ")

if adultos: 
    print("Adultos")
    mostrarResultados(adultos) 

else: 
    print("No se ingresó ninguna edad de adulto :) ")

if adultosmay: 
    print("Adultos mayores")
    mostrarResultados(adultosmay) 

else: 
    print("No se ingresó ninguna edad de ningún adulto mayor :) ")